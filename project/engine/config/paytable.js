...
const PAYTABLE_DECIMAL = {
  W: { 6: 20 }, // wild pays only on 6-of-a-kind; no 3/4/5-kind entry exists
  H5: { 3: 5, 4: 10, 5: 15, 6: 20 },
  H4: { 3: 2, 4: 5, 5: 12.5, 6: 15 },
  H3: { 3: 1.5, 4: 4, 5: 10, 6: 12.5 },
  H2: { 3: 1, 4: 2.5, 5: 7.5, 6: 10 },
  H1: { 3: 1, 4: 2.5, 5: 7.5, 6: 10 },
